...
export default function AuthGate({ children }: { children: ReactNode }) {
  ...
  return <div className="flex min-h-dvh items-center justify-center bg-ink p-5">
    <div className="w-full max-w-sm rounded-[28px] border border-white/[0.07] bg-panel p-6 shadow-[var(--shadow-overlay)] sm:p-8">
      <div className="mb-8 flex flex-col items-center text-center">
        <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-[18px] bg-accent text-2xl font-bold text-white">F</div>
