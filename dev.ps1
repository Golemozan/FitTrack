...
# ASPNETCORE_ENVIRONMENT=Development sart: Production'da oturum cerezi Secure (__Host-) olur,
# http://localhost uzerinden giris yapilamaz; User Secrets de okunmaz.
